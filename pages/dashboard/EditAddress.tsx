...
export default function EditAddress({detailAddress} : any) {
    ...
    const handleSubmit = (values: any) => {
        dispatch(fetchEditAddress(values)).then(() => {
          dispatch(setModalEdit(false));
        });
    };
    ...
    useEffect(() => {
        ...
        if (detailAddress) {
            formik.setValues({
                ...
                phone: detailAddress.phone || "",
                province_id: detailAddress.province_id || "",
                province_name: detailAddress.province_name || "",
                city_id: detailAddress.city_id || "",
                city_name: detailAddress.city_name || "",
                subdistrict_id: detailAddress.subdistrict_id || "",
                subdistrict_name: detailAddress.subdistrict_name || "",
                address: detailAddress.address || "",
                postal_code: detailAddress.postal_code || "",
                notes: detailAddress.notes || "",
                is_default: detailAddress.is_default || false,
            });
        }
    }, [detailAddress]);
                        ...
                        <div className='bg-white p-3'>
                            <div className='content text-xs'>
                                <div className='title flex justify-between'>
                                    <p className='text-sm font-semibold'>Ubah Alamat</p>
                                    <button
                                ...
                                <form onSubmit={formik.handleSubmit}>
                                    ...
                                    >
                                        <option value={formik.values.province_id}>{formik.values.province_name}</option>
                                    ...
                                    >
                                        <option value={formik.values.city_id}>{formik.values.city_name}</option>
                                    ...
                                    >
                                        <option value={formik.values.subdistrict_id}>{formik.values.subdistrict_name}</option>
